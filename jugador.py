...
"""class Assassin(pygame.sprite.Sprite):
    def __init__(self, posicion):
        ...
        self.rect.topleft = posicion
        self.frame = 0
        self.left_states = {0: (9, 254, 44, 52), 1: (9, 126, 44, 61), 2: (54, 126, 44, 63), 3: (99, 126, 44, 62),
                            4: (54, 254, 44, 62), 5: (99, 254, 44, 56)}
        self.right_states = {0: (144, 254, 44, 52), 1: (144, 126, 44, 61), 2: (189, 126, 44, 63), 3: (234, 126, 44, 62),
                             4: (189, 254, 44, 62), 5: (234, 254, 44, 56)}
        self.velocidad = [5, 0]
